...
Every number and verdict published here traces verbatim to a LazyAlpha report or the experiment registry. A FAIL or blocked result is stated just as plainly as a PASS; negative, incomplete, and non-evaluable outcomes are not hidden or softened. Nothing on this site is investment advice or evidence of a live track record.
